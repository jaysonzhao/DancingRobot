// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount2#deploy_0
    RETURN
    ** label2
