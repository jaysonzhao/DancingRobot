// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties20
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties20#deploy_0
    RETURN
    ** label2
