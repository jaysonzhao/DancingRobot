// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit5
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit5#deploy_0
    RETURN
    ** label2
