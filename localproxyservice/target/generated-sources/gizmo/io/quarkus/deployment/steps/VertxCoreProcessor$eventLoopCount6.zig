// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount6
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount6#deploy_0
    RETURN
    ** label2
