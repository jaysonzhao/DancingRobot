// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit10
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingStaticInit10#deploy_0
    RETURN
    ** label2
