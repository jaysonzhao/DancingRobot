// Class: io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector1
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector1#deploy_0
    RETURN
    ** label2
