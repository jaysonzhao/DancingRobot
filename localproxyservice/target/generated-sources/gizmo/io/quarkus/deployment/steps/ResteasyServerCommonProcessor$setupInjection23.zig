// Class: io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection23
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ResteasyServerCommonProcessor$setupInjection23#deploy_0
    RETURN
    ** label2
