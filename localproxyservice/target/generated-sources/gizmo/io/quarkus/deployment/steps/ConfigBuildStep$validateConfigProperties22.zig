// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties22
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties22#deploy_0
    RETURN
    ** label2
