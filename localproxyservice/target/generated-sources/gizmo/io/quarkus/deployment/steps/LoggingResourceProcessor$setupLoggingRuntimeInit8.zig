// Class: io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit8
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LoggingResourceProcessor$setupLoggingRuntimeInit8#deploy_0
    RETURN
    ** label2
