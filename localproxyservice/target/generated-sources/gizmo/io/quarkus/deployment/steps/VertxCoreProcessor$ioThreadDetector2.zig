// Class: io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector2
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector2#deploy_0
    RETURN
    ** label2
