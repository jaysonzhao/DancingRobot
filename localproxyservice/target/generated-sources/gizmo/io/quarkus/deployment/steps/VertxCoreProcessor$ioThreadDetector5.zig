// Class: io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector5
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector5#deploy_0
    RETURN
    ** label2
