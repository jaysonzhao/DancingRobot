// Class: io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP14
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/BlockingOperationControlBuildStep$blockingOP14#deploy_0
    RETURN
    ** label2
