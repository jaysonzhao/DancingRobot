// Class: io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector9
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$ioThreadDetector9#deploy_0
    RETURN
    ** label2
