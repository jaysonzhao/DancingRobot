// Class: io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean13
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/UndertowBuildStep$servletContextBean13#deploy_0
    RETURN
    ** label2
