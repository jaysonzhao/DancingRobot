// Class: io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties24
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/ConfigBuildStep$validateConfigProperties24#deploy_0
    RETURN
    ** label2
