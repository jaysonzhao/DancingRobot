// Class: io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent27
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/LifecycleEventsBuildStep$startupEvent27#deploy_0
    RETURN
    ** label2
