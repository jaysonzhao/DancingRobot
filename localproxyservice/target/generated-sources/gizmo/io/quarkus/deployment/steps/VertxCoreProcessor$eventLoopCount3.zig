// Class: io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount3
...
(
    ...
    ** label1
    ...
    INVOKEVIRTUAL io/quarkus/deployment/steps/VertxCoreProcessor$eventLoopCount3#deploy_0
    RETURN
    ** label2
